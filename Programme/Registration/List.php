...
if (isset($_SESSION['email'])) {
    ...
    $qry = $con->query("select *from register");
...
?>
    ...
    <body>
        <form method="POST">
            <table border="10px" style="border-color:chocolate;">
                <tr>
                    <th>First Name</th>
                    <th>Last Name</th>
                    <th>Email</th>
                ...
                <tr>
                    <?php while ($row = $qry->fetch(PDO::FETCH_ASSOC)) : ?>
                        ...
                        <td><img src="<?php echo $row['Photo']; ?>" width="150px" height="100px"></td>
        ...
        if (isset($_POST["dlt"])) {
            ...
            foreach ($_POST['delete'] as $ab) {
                $qry = $con->query("DELETE FROM `register` WHERE `id`=" . $ab);
            }
